...
//
//     final unSplashModelView = unSplashModelViewFromJson(jsonString);

import 'dart:convert';

UnSplashModelView unSplashModelViewFromJson(Map<String, dynamic> json) => UnSplashModelView.fromJson(json);

String unSplashModelViewToJson(UnSplashModelView data) => json.encode(data.toJson());

class UnSplashModelView {
  String? id;
  String? slug;
  ...
  factory UnSplashModelView.fromJson(Map<String, dynamic> json) => UnSplashModelView(
    id: json["id"],
    slug: json["slug"],
    ...
    links: json["links"] == null ? null : UnSplashModelViewLinks.fromJson(json["links"]),
    likes: json["likes"],
...
class UnSplashModelViewLinks {
  String? self;
  String? html;
  String? download;
  String? downloadLocation;

  UnSplashModelViewLinks({
    this.self,
    this.html,
    this.download,
  ...
  factory UnSplashModelViewLinks.fromJson(Map<String, dynamic> json) => UnSplashModelViewLinks(
    self: json["self"],
    html: json["html"],
